      ...
      <Box display={'flex'} justifyContent={'center'}>
        <Box
          ...
          style={{
            ...
            height: '2146px',
            background: darkMode
              ? "linear-gradient( rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4) ), url('https://storage.yandexcloud.net/aukus-2025-prod/aukus_map_compressed.png')"
              : 'url("https://storage.yandexcloud.net/aukus-2025-prod/aukus_map_compressed.png")',
            backgroundRepeat:
