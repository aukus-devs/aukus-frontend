    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          'В донате должны быть указаны названия конкретных игр, если в донате нет названия конкретной игры то участник имеет право отклонить этот донат, либо, если есть возможность участник может уточнить у донатера конкретную игру',
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          'В донате должно быть явно указано что донат на шейх-момент, словами "шейх", "дроп"',
          'За донат в 25.000 ₽ [50.000 ₽] донатер может с 50% вероятностью вынудить стримера дропнуть текущую игру (если успеть до финальных титров). Стример должен выпить шот или сделать физическое упражнение (отжимания или приседания), независимо от результата дропа. Эти деньги идут только на дроп, а не на заказ новой игры. "Шейх-момент" можно активировать только во время игры',
          'Если выпал вариант не дропать, каждый последующий шейх-момент на текущей игре стоит на 25.000 ₽ [50.000 ₽] дороже, то есть 50.000 ₽ [100.000 ₽], потом 75.000 ₽ [150.000 ₽] и тд.',
