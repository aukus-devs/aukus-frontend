...
const playerRules: Rule[] = [
  ...
  },
  {
    ...
    content: [
      {
        title: 'Информаций текущей игре',
        content: [
          'Стример должен ставить игру-категорию стрима только когда он играет в эту игру, во время аука, просмотра видео и тд должна стоять категория Just Chatting (или аналогичная)',
          'Стример должен показывать возможность шейх-момента и сумму на стриме всегда когда он доступен (во время прохождения игры)',
        ],
      },
      {
