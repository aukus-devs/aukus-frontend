...
const PlayersContent: { [k in PlayerUrl]: PlayerContentType } = {
  ...
  uselessmouth: {
    ...
    video_link: 'https://storage.yandexcloud.net/aukus-2025-prod/UselessMouth0.mp4',
  },
  vovapain: {
    funny_title: 'The road will be mastered by the walking',
    nomination_title: 'Король уличных дорог',
    image: VovapainImage,
    video_link: 'https://storage.yandexcloud.net/aukus-2025-prod/vovapain_3.mp4',
  },
}
